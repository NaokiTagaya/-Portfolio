...
RSpec.describe 'Review', type: :feature do
  ...
  scenario '店舗のレビュー一覧を表示' do
    ...
    expect(page).to have_selector("img[alt='1' src$='star-on-88233ad1abcd2282b53edb9465a6bef42fd32de319f014e4059353e4fd8a7e0a.png']")
    expect(page).to have_selector("img[alt='2' src$='star-on-88233ad1abcd2282b53edb9465a6bef42fd32de319f014e4059353e4fd8a7e0a.png']")
    expect(page).to have_selector("img[alt='3' src$='star-on-88233ad1abcd2282b53edb9465a6bef42fd32de319f014e4059353e4fd8a7e0a.png']")
    expect(page).to have_selector("img[alt='4' src$='star-on-88233ad1abcd2282b53edb9465a6bef42fd32de319f014e4059353e4fd8a7e0a.png']")
    expect(page).to have_selector("img[alt='5' src$='star-off-cf9b07584547d5d561dfac9cdbf7b6a530cb72a1b7a1096411966036c4017d38.png']")
